...
<html>
  ...
  <body class="bg-red-100" style="outline: 0; width: 100%; min-width: 100%; height: 100%; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; font-family: Helvetica, Arial, sans-serif; line-height: 24px; font-weight: normal; font-size: 16px; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; box-sizing: border-box; color: #000000; margin: 0; padding: 0; border-width: 0;" bgcolor="#f8d7da">
    <table class="bg-red-100 body" valign="top" role="presentation" border="0" cellpadding="0" cellspacing="0" style="outline: 0; width: 100%; min-width: 100%; height: 100%; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; font-family: Helvetica, Arial, sans-serif; line-height: 24px; font-weight: normal; font-size: 16px; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; box-sizing: border-box; color: #000000; margin: 0; padding: 0; border-width: 0;" bgcolor="#f8d7da">
      <tbody>
        <tr>
          <td valign="top" style="line-height: 24px; font-size: 16px; margin: 0;" align="left" bgcolor="#2b4e72">
                      ...
                      <tbody>
                        <tr>
                          <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                            ...
                            <div class="space-y-4">
                              <h1 class="text-4xl fw-800" style="color:#ffffff !important; padding-top: 0; padding-bottom: 0; font-weight: 800 !important; vertical-align: baseline; font-size: 36px; line-height: 43.2px; margin: 0;" align="left">Thanks for your order,  {{ $order->name }}</h1>
                              ...
                              <p class="" style="color:#ffffff; line-height: 24px; font-size: 16px; width: 100%; margin: 0;" align="left">The estimated delivery time for your order is 6:10 PM - 6:20 PM. Track your order on the Hip Corp website.</p>
                              <table class="s-4 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                                <tbody>
                                  <tr>
                                    <td style="line-height: 16px; font-size: 16px; width: 100%; height: 16px; margin: 0;" align="left" width="100%" height="16">
                              ...
                              <tbody>
                                <tr>
                                  <td style="line-height: 24px; font-size: 16px; width: 100%; border-radius: 24px; margin: 0; padding: 40px;" align="left" bgcolor="#ffffff">
                                    ...
                                    <p class="text-center text-muted" style="line-height: 24px; font-size: 16px; color: #718096; width: 100%; margin: 0;" align="center">Receipt #{{ $order->id }}</p>
                                    <p class="text-center text-muted" style="line-height: 24px; font-size: 16px; color: #718096; width: 100%; margin: 0;" align="center">{{ $order->email }}</p>
                                    <p class="text-center text-muted" style="line-height: 24px; font-size: 16px; color: #718096; width: 100%; margin: 0;" align="center"> {{ $order->name }}</p>
                                    <table class="p-2 w-full" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                                      <tbody>
                                        ...
                                        <tr>
                                          <td style="line-height: 24px; font-size: 16px; width: 33.33%; margin: 0; padding: 8px; text-align: left;" align="left">{{ $product->name }}</td>
                                          <td style="line-height: 24px; font-size: 16px; width: 33.33%; margin: 0; padding: 8px; text-align: center;" align="center">{{$product->pivot->cantidad}}</td>
                                          <td style="line-height: 24px; font-size: 16px; width: 33.33%; margin: 0; padding: 8px; text-align: right;" align="right">RD${{ number_format($product->precio_oferta, 2) }}</td>
                                        </tr>
                                        @endforeach
                                          <td class="fw-700 border-top" style="border-top-color: #e2e8f0 !important; border-top-style: solid !important; border-top-width: 1px !important; line-height: 24px; font-size: 16px; width: 33.33%; margin: 0; padding: 8px; text-align: left; font-weight: 700 !important;" align="left">Total:</td>
                                          <td class="fw-700 border-top" style="border-top-color: #e2e8f0 !important; border-top-style: solid !important; border-top-width: 1px !important; line-height: 24px; font-size: 16px; width: 33.33%; margin: 0; padding: 8px; text-align: center; font-weight: 700 !important;" align="center"></td>
                                          <td class="fw-700 border-top" style="border-top-color: #e2e8f0 !important; border-top-style: solid !important; border-top-width: 1px !important; line-height: 24px; font-size: 16px; width: 33.33%; margin: 0; padding: 8px; text-align: right; font-weight: 700 !important;" align="right">RD${{ number_format($order->total, 2) }}</td>
                                        </tr>
                                      </tbody>
                                    </table>
                                    <table class="s-6 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                                    ...
                                    <p style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;" align="left">If you have any questions, contact us at <a href="https://bootstrapemail.com" style="color: #0d6efd;"><span class="__cf_email__" data-cfemail="95ddfce5d6fae7e5d5f0edf4f8e5f9f0bbf6faf8">[email&#160;protected]</span></a>.</p>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
